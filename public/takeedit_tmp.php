...
dbconn();
require_once(get_langfile_path('takeedit.php'));
loggedinorreturn();
...
$res = sql_query("SELECT id, category, owner, filename, save_as, anonymous, picktype, picktime, added, pt_gen, banned FROM torrents_tmp WHERE id = ".mysql_real_escape_string($id));
...
$sql = "UPDATE torrents_tmp SET " . join(",", $updateset) . " WHERE id = $id";
...
$returl = "details_tmp.php?id=$id&edited=1";
